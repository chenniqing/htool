...
public class PinyinConverter {
	...
	/** 简体中文的编码范围从B0A1（45217）*/
	private static int BEGIN = 45217;
	/** 简体中文的编码范围一直到F7FE（63486） */
	private static int END = 63486;
	/**
	 * 按照声 母表示，这个表是在GB2312中的出现的第一个汉字，也就是说“啊”是代表首字母a的第一个汉字。
	 * i, u, v都不做声母, 自定规则跟随前面的字母
	 */
	private static char[] CHAR_TABLE = {'啊', '芭', '擦', '搭', '蛾', '发', '噶', '哈', '哈', '击', '喀', '垃', '妈', '拿', '哦', '啪', '期', '然', '撒', '塌', '塌', '塌', '挖', '昔', '压', '匝'};
	/**
	 * 二十六个字母区间对应二十七个端点
	 * GB2312码汉字区间十进制表示
	 */
	 ...
	 * @return
	 */
	public String toPinyin(String sourceStr) {
		String result = "";
